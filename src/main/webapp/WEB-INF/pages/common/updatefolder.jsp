...
<input name="img" id="img" value="" type="hidden">
 <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" id="name" name="name" value="${menu.name }" style="width: 80%" autocomplete="off" placeholder="请输入标题" class="layui-input">
    </div>
  </div>
</form>
...
<div style="width: 150px;height: 150px;border: solid 1px #555;padding: 5px;margin-top: 10px;margin-left: 110px;">
    <img id="finalImg" src="${menu.img }" width="100%">
</div>
...
function commit1(){
	...
	$.ajax({  
        url: "${pageContext.request.contextPath }/common/updatefolder",
        type: 'POST',  
        data: form,  
